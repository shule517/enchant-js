...
// class Object extends enchant.Group {
//   constructor() {
//     super();
//   }

//   readSound(music_key) {
//     return enchant.Core.instance.assets['img/choo.mp3'].clone();
//   }
// }

// export default class Suta extends Object {
//   constructor(width, height, x) {
//     this.soundChoo = readSound('img/choo.mp3');
//     this.soundJan = readSound('img/Quiz-Results.mp3');
//   }

//   soundChoo() {
//     this.soundChoo.play();
//     this.soundChoo.volume = 0.4;
//   }

//   soundJan() {
//     this.soundJan.play();
//     this.soundJan.volume = 0.5;
//   }
